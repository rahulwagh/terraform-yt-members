...
resource "aws_subnet" "dev_proj_1_public_subnets" {
  ...
  # Assign an IPv6 CIDR block
  #ipv6_cidr_block = cidrsubnet(aws_vpc.dev_proj_1_vpc_eu_central_1.ipv6_cidr_block, 56, count.index)
  ipv6_cidr_block = cidrsubnet(aws_vpc.dev_proj_1_vpc_eu_central_1.ipv6_cidr_block, 8, var.public_subnet_ipv6_prefixes[count.index])
...
resource "aws_subnet" "dev_proj_1_private_subnets" {
  ...
  # Assign an IPv6 CIDR block
  #ipv6_cidr_block = cidrsubnet(aws_vpc.dev_proj_1_vpc_eu_central_1.ipv6_cidr_block, 56, count.index)
  ipv6_cidr_block = cidrsubnet(aws_vpc.dev_proj_1_vpc_eu_central_1.ipv6_cidr_block, 8, var.private_subnet_ipv6_prefixes[count.index])
